  ...
  return (
    <div className="h-[165px] select-none xl:h-20 flex flex-col justify-between xl:space-y-0 xl:flex-row w-28 lg:w-48 xl:w-full xl:flex-nowrap xl:space-x-3">
      ...
      <Link
        ...
        className="group relative overflow-hidden bg-gradient-to-r from-gray-500 to-gray-400 hidden h-20 xl:flex justify-start items-center text-white rounded-xl xl:hover:w-1/2 xl:w-1/3 transition-all duration-500 ease-in"
      >
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "url('https://pandahrjp.notion.site/image/https%3A%2F%2Fprod-files-secure.s3.us-west-2.amazonaws.com%2F94040031-af1f-40e9-9ae7-2d9da0e21c8e%2F3dceb431-f619-4577-81ae-383964ddd16d%2Fnew_logo%25E5%2588%25B6%25E4%25BD%259C.png?table=block&id=553d15b4-2e06-4165-af46-907119c9ec3c&spaceId=94040031-af1f-40e9-9ae7-2d9da0e21c8e&width=2000&userId=&cache=v2') no-repeat center /cover"
          }}
        ></div>
      </div>
    </div>
