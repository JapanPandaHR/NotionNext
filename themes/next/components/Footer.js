  ...
  return (
        ...
        >
            ...
            <span>
                ...
                <br />
                <h1>{title}</h1>
                <span className='text-xs font-serif  text-gray-500 dark:text-gray-300 '>Powered by  <a href='https://www.pandahr.jp/' className='underline '>PandaHR {BLOG.VERSION}</a>.</span>
            </span>
        </footer>
  )
}
