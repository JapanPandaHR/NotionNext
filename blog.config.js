...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'PandaHR | 畔达东瀛', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '赴日就职综合支援🐼', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.pandahr.jp/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '赴日就职, 在日就职, PandaHR, 日本留学, 日本工作, 日本正社员, 0日语赴日, 畔达东瀛', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'kei@pandahr.jp', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/watomirai', // 你的twitter个人主页
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个由PandaHR成立的站点', // 站点描述，被notion中的页面描述覆盖
